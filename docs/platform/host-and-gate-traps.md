...
|---|---|
| `tests/m0/` | 8081 · 9000 |
| `tests/serve/` | 9100–9109 (9107–9109 are the thread-model section, G140) |
...
| `bench/` (M3) | 9940–9953, 9956–9960 (range 9940–9960 reserved) — 9940–9943 the four contenders in `bench/case/static-throughput.sh`, 9944–9945 the two variants in `bench/diag/respond-ceiling.sh`, 9946–9948 the origin and two cache-backend variants in `bench/diag/cache-hit-p99.sh`, 9949–9953 the origin and four contenders in `bench/case/reverse-proxy-throughput.sh`, 9956–9959 the four contenders and 9960 the request-capture stub in `bench/case/short-connection-throughput.sh` — ⚠ **different container, own netns**, see below |
